      ...
      <div class="form-group p-t-20" v-if="!files.file">
        <div class="col-md-12 text-center is-fileinput">
          <span class="btn btn-info btn-file">
            ...
            <input style="display:" type="file" accept="application/vnd.openxmlformats-officedocument.spreadsheetml.sheet,.pdf,.ppf,.doc,.docx" v-on:change="onBrowse('http://localhost/api/fileupload',$event)">
          </span>
        </div>
      </div>
      <br>
